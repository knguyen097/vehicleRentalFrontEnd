...
async function fetchVehicles()
{
    ...
    if (!res.ok)
    {
        els.resultCount.textContent = 'Failed to load vehicles';
        els.grid.innerHTML = `<div class="muted">Error loading vehicles.</div>`;
        return;
    }
...
if (els.signInBtn)
{
    els.signInBtn.addEventListener('click', () =>
    {
        ...
        // if logged in, we just use hover to show dropdown
    });
}
...
document.addEventListener('click', async (event) =>
{
    ...
    try
    {
        ...
        {
            // not valid JSON – leave data as null
        }
